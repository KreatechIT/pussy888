<div class="min-h-screen bg-black text-white">
    ...
    <div class="mx-auto max-w-7xl px-4 py-10">
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <ul class="list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
                <li>Be at least 18 years old or of legal gambling age in your jurisdiction.</li>
                <li>Abide by all applicable local, national, and international laws.</li>
                <li>Not reside in a country or region where online gambling is prohibited.</li>
                <li>We reserve the right to request age or identity verification at any time.</li>
            </ul>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <ul class="list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
                <li>Create an account with a username and secure password.</li>
                <li>Provide valid mobile number and email address.</li>
                <li>You are responsible for keeping login credentials confidential — all account activity is deemed your
                    own.</li>
            </ul>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <p class="text-sm text-white/80 sm:text-base">
                ...
                temporary break, or self-exclude.
                If you feel your gambling is out of control, we encourage you to seek help from professional support
                services.
            </p>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <p class="text-sm text-white/80 sm:text-base">
                All games use certified Random Number Generators (RNG) to ensure fair and unbiased outcomes.
                Our platform is regularly audited by third-party agencies for compliance and integrity.
            </p>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <ul class="list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
                ...
                <li>Expiry dates are enforced.</li>
                <li>Certain promotions may apply only to specific games.</li>
                <li>Pussy888 reserves the right to amend or withdraw promotions at its discretion. Abuse may lead to
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <ul class="list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
                <li>Secure transactions supported via local bank transfers and e-wallets.</li>
                <li>Minimum and maximum limits apply to deposits/withdrawals.</li>
                <li>Withdrawals may require identity verification.</li>
                <li>All transactions are processed in Malaysian Ringgit (MYR), unless otherwise stated.</li>
                <li>Fraudulent or suspicious activity may delay or block withdrawals.</li>
            </ul>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <ul class="list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
                ...
                <li>Using bots, scripts, or automation tools to play games.</li>
                <li>Selling, transferring, or renting accounts.</li>
                <li>Sharing or publishing harmful, offensive, or illegal content.</li>
                <li>Violation may result in permanent account suspension without notice.</li>
            </ul>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <p class="text-sm text-white/80 sm:text-base">
                ...
                our company.
                You may not copy, distribute, modify, or reproduce any part without prior written consent.
            </p>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <ul class="list-inside list-disc space-y-1 text-sm text-white/80 sm:text-base">
                <li>We are not liable for damages due to technical issues, internet disruptions, or downtime.</li>
                <li>We do not guarantee uninterrupted or error-free services.</li>
                <li>Use of our platform is entirely at your own risk.</li>
            </ul>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <p class="text-sm text-white/80 sm:text-base">
                We may update these Terms at any time. Continued use of the platform after changes means acceptance.
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <p class="text-sm text-white/80 sm:text-base">
                ...
                suspect fraud, a breach of terms, or illegal activity.
            </p>
        </div>
        ...
        <div class="mb-6 rounded-xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <p class="text-sm text-white/80 sm:text-base">
                These Terms shall be governed and interpreted in accordance with the laws of Malaysia.
                Any disputes will be resolved under Malaysian jurisdiction.
            </p>
        </div>
